...
const experienceItems: ExperienceItem[] = [
  ...
  },
  {
    ...
    externalLink:
      "https://www.amazon.com/-/es/Luis-martinez-pedro-revelaciones-spanish-cuban/dp/8494687131",
  ...
  return (
    <div className="fixed inset-0 z-50 bg-white overflow-auto">
      ...
      <a
        ...
        className="fixed top-20 right-5 md:top-24 md:right-6 px-4 py-2 border border-zinc-400 bg-white/80 text-zinc-700 font-medium uppercase  hover:bg-zinc-100 hover:text-[#ff2f00] transition-colors z-50 shadow-sm"
      ...
      <div className="p-10 max-w-7xl mx-auto space-y-8 relative text-center">
        ...
        <header className="space-y-4 border-b border-zinc-200 pb-8 mt-10">
          ...
          <p className="magazine-dek">My CV is ready to be viewed.</p>
        ...
        <section
          id="experience-roles"
          ref={rolesRef}
          className="space-y-6 mb-6 mt-12 flex flex-col gap-6"
        >
          ...
          {experienceItems.map((item) => (
            <article
              key={item.title}
              className="bg-zinc-100 border border-zinc-200 p-7 md:p-8"
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 items-start">
                <div className="text-zinc-800 leading-relaxed text-center magazine-body">
                  ...
                  {item.period && (
                    <p className="text-zinc-600 mb-3">{item.period}</p>
                  )}
                  ...
                  {item.description ? (
                    <>
                      <p className="mt-3 text-left whitespace-pre-line">
                        {item.description}
                      </p>
                        ...
                        <div className="mt-4 grid grid-cols-2 gap-3">
                          {item.images.map((image, imageIndex) => (
                            <div
                              ...
                              style={{
                                animationDelay: `${(imageIndex % 6) * 0.2}s`,
                              }}
                            >
                              <Image
                                src={image.src}
                    ...
                    <ul className="list-disc list-inside space-y-2 mt-3 text-left">
                ...
                <div className="bg-zinc-50 border border-zinc-300 p-4">
                  {item.images && item.images.length > 0 ? (
                    ...
                    <div className="aspect-4/3 border border-dashed border-zinc-400 bg-white/70 grid place-items-center text-center p-6">
                      <div>
                        <p className="text-sm uppercase tracking-[0.12em] text-zinc-500 mb-2">
                          Image Space Ready
                        </p>
                        <p className="text-zinc-700 text-sm">
                          Add process or final images to this card by filling
                          the images array for {item.title}.
                        </p>
                      </div>
                    </div>
                  )}
        ...
        <footer className="mt-14 border-t border-zinc-300 pt-6">
          ...
          <p className="text-sm text-zinc-700 leading-relaxed max-w-3xl mx-auto">
            This section is structured as a living archive: each role is
            presented as field notes, process context, and references instead
            of a traditional CV timeline.
          </p>
        </footer>
      </div>
    </div>
