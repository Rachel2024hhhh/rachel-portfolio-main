...
const PrintMatter3D: React.FC<{ isVisible: boolean; onClose: () => void }> = ({ isVisible, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-white overflow-auto">
      ...
      <div className="p-10">
        {/* Wrapped section for easy duplication of future projects */}
        <div className="project-section">
          ...
          <div ref={project3DRef} className="mb-6 mt-12 flex flex-col gap-6 relative">
            ...
            {/* 3D Canvas + Text – FIXED HERE: removed fit from Bounds, added damping to OrbitControls */}
              ...
              <div className="md:w-1/2 w-full h-96 md:h-128 shadow-md overflow-hidden relative">
                {mounted && (
                  ...
                  >
                    ...
                    >
                      <Bounds clip observe margin={1.2}>  {/* removed fit */}
                    ...
                    <OrbitControls
                      ...
                      autoRotate
                      autoRotateSpeed={0.3}
                      enableDamping          // added for smoother camera (helps avoid perceived jitter)
                      dampingFactor={0.05}   // added – tune between 0.03–0.1 if needed
                    />
        ...
        {/* ^^^ End of project-section — duplicate the whole <div className="project-section">...</div> block here for the next project */}
      </div>
    </div>
  );
};
